...
{
    {
        ...
        auto preferred_size = m_timeline_view->layout()->preferred_size(*m_timeline_view);
...

    {
        ...
        auto preferred_size = m_header_container->layout()->preferred_size(*m_header_container);
