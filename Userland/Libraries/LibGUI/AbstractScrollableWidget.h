...
public:
    ...
    // Any subclass which will be used with this set to true
    // must make use of update_scrollbar_visibility() and set_min_content_size()
    // (see ScrollableContainerWidget() for reference)
