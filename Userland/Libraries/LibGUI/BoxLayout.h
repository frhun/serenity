...
public:
    ...
    virtual Gfx::IntSize preferred_size(Widget const&) const override;

protected:
    explicit BoxLayout(Gfx::Orientation);

private:
    int preferred_primary_size(Widget const&) const;
    int preferred_secondary_size(Widget const&) const;
